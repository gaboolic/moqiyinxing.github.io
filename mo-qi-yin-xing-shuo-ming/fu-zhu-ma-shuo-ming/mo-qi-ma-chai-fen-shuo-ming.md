...
墨奇码是一个基于字形描述信息、递归拆分至最小字形，最后取首末双形音托的方案。

拆分码表在github上开源：[https://github.com/gaboolic/moqima-tables](https://github.com/gaboolic/moqima-tables)

最小字形的定义：笔画，或者在字根表的字（一般为独体字或者传统部首）。

左右、上下、包围必拆，字根不拆。笔画相连视为独体字，例如“灭”为上下结构（一和火不相连），“正”为独体字（一和止相连）。
...
稍微特殊点的：赢嬴，辩辨，班斑 弼粥 衍衔 微徵 衷袤视为包围。 例如赢拆分为𣎆贝,𣎆拆分为⿱⿱亡口⿰月凡，最后首末为亡贝，嬴首末为亡女；衷拆分为衣中；斑拆分为玨文，继续拆分为王王文，取首末为王文；辩首末为辛讠。
...
![墨奇音形字根图](https://private-user-images.githubusercontent.com/3831173/333104058-626cec83-5008-4d60-9e0e-46ce1328bb01.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..FCszZKadd9JL1rc-8cOgc5WF0MH4b7yJebteXhOR8Fw)
...
十𠂇𬺰{伞下} 豕(读作shi)豖𧰨 尸𠃜 市巿 氏氐 水⺢氺{水} 束朿 矢 勺 石 山 手龵 殳 饣 示 少𣥂 申 术 舌 上 身 生 史 世

### i



川𫶧 𡗗 虫 车 臣𦣞 厂𠂆 叉 斥 长 辰 成 赤 尺 丑 出 串 𤰔(車惠的上部) 丞
...
扌 非𠀎 父 丰龶{寿上丰}𰀁㐄 分 方 弗 乏 风 甫 阜 夫 {𠃊丿}（发上面） 凡 缶(读fou)
...
我：视为戈字包含结构，拆分类似戴。拆分为⿹{戈丿}{亅㇀}，{戈丿}继续拆分为戈丿，{亅㇀}拆分为亅㇀。最终结果为：戈丿亅㇀。
